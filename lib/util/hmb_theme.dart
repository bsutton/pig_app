...
class HMBColors {
  ...
  static const errorBackground = Color(0xFFda6379);
  ...
  static const helpIcon = Color(0xFF0000FF);

  /// the background color of the main app bar
  static const appBarColor = Color(0xFFBB86FC);
  ...
  static const surface0dp = Color(0xFF000000);
